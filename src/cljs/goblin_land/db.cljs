...
Exits: a trapdoor [down], a set of swinging doors [west]."
                      ...
                      :npcs {"Chef" {:responses ["Back to work!!"]}
                             "Thrashikeet" {:responses ["*in your mind, you seem to hear it say: \"help me\"..."]}}
            ...
            :root-cellar {:id :root-cellar
                          ...
                          :npcs {"Drunk Orc" {:responses ["uuhr you 'posed to be he'h?"]}
                                 "Healer" {:responses ["now mista orc, drink dis for meh"]}}}
            ...
            :dining-room {:id :dining-room
                          ...
                          :npcs {"waiter" {:responses ["got to get to the Cyclops at table 9!"]}
                                 ...
                                 "Gargle Squid" {:responses ["GAAAAARRRRRGGGGLLLE???"]}
                                 "Witch" {:responses ["i'll get you my pretty and your- uh... YOU DONT HAVE ANYTHING?!? *cackle*"]}
                                 "Cyborg" {:responses ["-_-"]}}}})
